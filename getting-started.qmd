...
- Palmer penguins plot from the [**palmerpenguins**]({{< var penguins >}}) package by Allison Horst.
- "Case" art by [Allison Horst]({{< var horst_art >}})
- Danielle Navarro's book ["Learning Statistics With R"]({{< var navarro_book >}})
- Jenny Bryan's [STAT 545 Course]({{< var stat545 >}})
- [Modern Dive]({{< var modern_dive >}}), by Chester Ismay & Albert Y. Kim
