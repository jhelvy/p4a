...
1) Open up your "data-analysis-tutorial" R Project that you created in the last lesson - if you didn't do this, [go back and do it now](data-frames.html#r-setup).
...
![](images/horst_monsters_data_wrangling.png){ width=600 }
...
<center>
![](images/data-wrangle.png){ width=600 }
</center>
[[Image source](https://r4ds.had.co.nz/introduction.html)]{.aside}
...
![](images/rstudio-cheatsheet-select.png){ width=600 }
...
![](images/rstudio-cheatsheet-filter.png){ width=600 }
...
[Logo is a reference to [The Treachery of Images](https://en.wikipedia.org/wiki/The_Treachery_of_Images) by Belgian surrealist painter René Magritte.]{.aside}
...
![](images/rstudio-cheatsheet-mutate.png){ width=600 }
...
![](images/rstudio-cheatsheet-group_by.png){ width=600 }
...
![](images/rstudio-cheatsheet-summarise.png){ width=600 }
